...
SAMSUNG_ROOT = os.environ.get(
    "SENSECV_SAMSUNG_ROOT",
    os.path.join(
        PROJECT_ROOT,
        "data",
        "datasets",
        "SenseCV-30-05-2026-IFCE-Gimbal-Samsung",
        "SenseCV-30-05-2026-IFCE-Gimbal-Samsung",
    ),
)
METADATA_CSV = os.environ.get(
    "SENSECV_SAMSUNG_METADATA_CSV",
    os.path.join(PROJECT_ROOT, "data", "datasets", "samsung_metadata.csv"),
)
OUT_ROOT = os.environ.get("DRONET_SAMSUNG_OUT_DIR", os.path.join(PROJECT_ROOT, "data", "dronet_results", "samsung_random_samples"))
SAMPLES_PER_CLIP = 20
